...
func (r *HMACAuthResourceModel) ToSharedCreateHMACAuth() *shared.CreateHMACAuth {
	var consumer *shared.CreateHMACAuthConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateHMACAuthConsumer{
			ID: id,
		}
	}
	secret := new(string)

...
func (r *UpstreamResourceModel) ToSharedCreateUpstream() *shared.CreateUpstream {
...
func (r *UpstreamResourceModel) RefreshFromSharedUpstream(resp *shared.Upstream) {
	...
	if resp.ClientCertificate == nil {
		...
		r.ClientCertificate = &CreateACLConsumer{}
	...
	if resp.Healthchecks == nil {
		...
		if resp.Healthchecks.Active == nil {
			...
			if resp.Healthchecks.Active.Healthy == nil {
				...
				r.Healthchecks.Active.Healthy = &Healthy{}
				r.Healthchecks.Active.Healthy.HTTPStatuses = nil
		...
		if resp.Healthchecks.Passive == nil {
			...
			r.Healthchecks.Passive = &Passive{}
			if resp.Healthchecks.Passive.Healthy == nil {
				r.Healthchecks.Passive.Healthy = nil
			} else {
				r.Healthchecks.Passive.Healthy = &CreateUpstreamHealthy{}
				r.Healthchecks.Passive.Healthy.HTTPStatuses = nil

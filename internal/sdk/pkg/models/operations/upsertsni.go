...
type UpsertSniRequestBody struct {
	...
	Certificate UpsertSniRequestBodyCertificate `json:"certificate"`
...
type UpsertSniRequest struct {
	...
	RequestBody *UpsertSniRequestBody `request:"mediaType=application/json"`
...
// UpsertSni400ApplicationJSON - Invalid SNI
type UpsertSni400ApplicationJSON struct {
}

// UpsertSni200ApplicationJSONDataCertificate - The id (a UUID) of the certificate with which to associate the SNI hostname. The Certificate must have a valid private key associated with it to be used by the SNI object.
type UpsertSni200ApplicationJSONDataCertificate struct {
	// The unique identifier or the name attribute of the Certificate whose SNIs
	ID *string `json:"id,omitempty"`
}

type UpsertSni200ApplicationJSONData struct {
	...
	//
	Certificate *UpsertSni200ApplicationJSONDataCertificate `json:"certificate,omitempty"`
...
// UpsertSni200ApplicationJSON - SNI response object
type UpsertSni200ApplicationJSON struct {
	// Array of SNIs
	Data []UpsertSni200ApplicationJSONData `json:"data,omitempty"`
...
type UpsertSniResponse struct {
	...
	// SNI response object
	UpsertSni200ApplicationJSONObject *UpsertSni200ApplicationJSON
	// Invalid SNI
	UpsertSni400ApplicationJSONObject *UpsertSni400ApplicationJSON
}

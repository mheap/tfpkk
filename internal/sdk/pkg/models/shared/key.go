...
// KeySchemasSet - The id (an UUID) of the key-set with which to associate the key.
type KeySchemasSet struct {
	ID *string `json:"id,omitempty"`
}

func (o *KeySchemasSet) GetID() *string {
	if o == nil {
		return nil
	}
	return o.ID
...
type Key struct {
	...
	Set *KeySchemasSet `json:"set,omitempty"`
...
func (o *Key) GetSet() *KeySchemasSet {
	if o == nil {
		return nil
	}
	return o.Set

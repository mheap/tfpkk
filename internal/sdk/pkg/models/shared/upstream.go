...
type UpstreamSchemasHealthy struct {
	HTTPStatuses []int64 `json:"http_statuses,omitempty"`
	Successes    *int64  `default:"0" json:"successes"`
}

func (u UpstreamSchemasHealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpstreamSchemasHealthy) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *UpstreamSchemasHealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
	return o.HTTPStatuses
...
func (o *UpstreamSchemasHealthy) GetSuccesses() *int64 {
	if o == nil {
		return nil
	}
	return o.Successes
...
type UpstreamSchemasType string

const (
	UpstreamSchemasTypeTCP   UpstreamSchemasType = "tcp"
	UpstreamSchemasTypeHTTP  UpstreamSchemasType = "http"
	UpstreamSchemasTypeHTTPS UpstreamSchemasType = "https"
	UpstreamSchemasTypeGrpc  UpstreamSchemasType = "grpc"
	UpstreamSchemasTypeGrpcs UpstreamSchemasType = "grpcs"
)

func (e UpstreamSchemasType) ToPointer() *UpstreamSchemasType {
	return &e
}

func (e *UpstreamSchemasType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "grpc":
		fallthrough
	case "grpcs":
		*e = UpstreamSchemasType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpstreamSchemasType: %v", v)
	}
}

type UpstreamSchemasUnhealthy struct {
	HTTPFailures *int64  `default:"0" json:"http_failures"`
	HTTPStatuses []int64 `json:"http_statuses,omitempty"`
	TCPFailures  *int64  `default:"0" json:"tcp_failures"`
	Timeouts     *int64  `default:"0" json:"timeouts"`
...
func (u UpstreamSchemasUnhealthy) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpstreamSchemasUnhealthy) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, false); err != nil {
		return err
	}
	return nil
...
func (o *UpstreamSchemasUnhealthy) GetHTTPFailures() *int64 {
	if o == nil {
		return nil
	}
	return o.HTTPFailures
...
func (o *UpstreamSchemasUnhealthy) GetHTTPStatuses() []int64 {
	if o == nil {
		return nil
	}
	return o.HTTPStatuses
...
func (o *UpstreamSchemasUnhealthy) GetTCPFailures() *int64 {
	if o == nil {
		return nil
	}
	return o.TCPFailures
...
func (o *UpstreamSchemasUnhealthy) GetTimeouts() *int64 {
	if o == nil {
		return nil
	}
	return o.Timeouts
...
type UpstreamPassive struct {
	Healthy   *UpstreamSchemasHealthy   `json:"healthy,omitempty"`
	Type      *UpstreamSchemasType      `default:"http" json:"type"`
	Unhealthy *UpstreamSchemasUnhealthy `json:"unhealthy,omitempty"`
}
...
func (o *UpstreamPassive) GetHealthy() *UpstreamSchemasHealthy {
	if o == nil {
		return nil
	}
	return o.Healthy
...
func (o *UpstreamPassive) GetType() *UpstreamSchemasType {
	if o == nil {
		return nil
	}
	return o.Type
...
func (o *UpstreamPassive) GetUnhealthy() *UpstreamSchemasUnhealthy {
	if o == nil {
		return nil
	}
	return o.Unhealthy
